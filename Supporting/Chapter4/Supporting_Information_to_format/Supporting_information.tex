...
\caption[Trait coverage, including coverage for diet information]{\textbf{Trait coverage, including coverage for diet information, calculated as the proportion of species for which trait values are not missing}. The dashed line represents 50\% coverage.}
\label{}
\end{figure}
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont
  \caption{\textbf{Summary for the PGLS model fitted on amphibians, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=4,537).} 
  \label{} 
...
\caption[]{\textbf{Diagnostic plots for the PGLS model fitted on amphibians, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=4,537).}
\label{}
\end{figure}
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont
  \caption{\textbf{Summary for the PGLS model fitted on birds, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=10,198).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\caption[]{\textbf{Diagnostic plots for the PGLS model fitted on birds, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=10,198).}
\label{}
\end{figure}
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on mammals, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=4,712).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\caption[]{\textbf{Diagnostic plots for the PGLS model fitted on mammals, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=4,712).}
\label{}
\end{figure}
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on reptiles, looking at the effects of species-level predictors on climate-change sensitivity.} We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=7,330).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\caption[]{\textbf{Diagnostic plots for the PGLS model fitted on reptiles, looking at the effects of species-level predictors on climate-change sensitivity. }We excluded species whose range area was $\leqslant$100 km\textbf{$^2$} (n=7,330).}
\label{}
\end{figure}
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on amphibians, looking at the effects of species-level predictors on climate-change sensitivity.} We included species whose range area was $\leqslant$100 km\textbf{$^2$} (n=5,197).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on birds, looking at the effects of species-level predictors on climate-change sensitivity.} We included species whose range area was $\leqslant$100 km\textbf{$^2$} (n=10,340).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on mammals, looking at the effects of species-level predictors on climate-change sensitivity.} We included species whose range area was $\leqslant$100 km\textbf{$^2$} (n=4,841).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on reptiles, looking at the effects of species-level predictors on climate-change sensitivity.} We included species whose range area was $\leqslant$100 km\textbf{$^2$} (n=7,945).} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont  
  \caption{\textbf{Summary for the PGLS model fitted on amphibians, \textit{using the complete trait data subset (excluding imputed values)}}, looking at the effects of the species-level predictors on climate-change sensitivity.} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on birds, \textit{using the complete trait data subset (excluding imputed values)}}, looking at the effects of the species-level predictors on climate-change sensitivity.} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on mammals, \textit{using the complete trait data subset (excluding imputed values)}}, looking at the effects of the species-level predictors on climate-change sensitivity.} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
\renewcommand{\arraystretch}{1}
\begin{center}\fontsize{9}{11}\selectfont 
  \caption{\textbf{Summary for the PGLS model fitted on reptiles, \textit{using the complete trait data subset (excluding imputed values)}}, looking at the effects of the species-level predictors on climate-change sensitivity.} 
  \label{} 
\begin{tabular}{@{\extracolsep{5pt}} ccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
