...
%% fix Hudson citation for PREDICTS (both)

%% Chapter 2 - references to figures in the SI

%% Chapter 3: add SI; references to figures in text and SI.

%% list of tables and figures -- separated for main and SI?

%% add Figure reproduced from "..." in pubished article figures

%% TODO chapter 2
%% relecture
%% SI: text + refs + bibliography
